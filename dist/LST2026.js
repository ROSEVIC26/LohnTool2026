...
// Hilfsfunktionen
// ---------------------------------------------------------------------------
const euroAbr = (v) => Math.floor(v);
const euroAuf = (v) => Math.ceil(v);
const centAuf = (v) => Math.ceil(v * 100.0) / 100.0;
const centAbr = (v) => Math.floor(v * 100.0) / 100.0;
...
// ---------------------------------------------------------------------------
function UP5_6(I) {
    I.X = euroAbr(I.ZX * 1.25);
    UPTAB26(I);
    I.ST1 = I.ST;
    I.X = euroAbr(I.ZX * 0.75);
    UPTAB26(I);
    I.ST2 = I.ST;
...
function UPANTEIL(I) {
    switch (I.P.LZZ) {
        case 1:
            ...
            break;
        case 2:
            I.ANTEIL1 = trunc(I.JW / 12);
            break;
        case 3:
            I.ANTEIL1 = trunc(I.JW * 7 / 360);
            break;
        case 4:
            I.ANTEIL1 = trunc(I.JW / 360);
            break;
    }
}
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export function LST2026_Init(P) {
    P.AF = 0;
    P.AJAHR = 0;
    P.ALTER1 = 0;
    P.ALV = 0;
...
export function LST2026_Berechne(P) {
    const I = {
...
//# sourceMappingURL=LST2026.js.map